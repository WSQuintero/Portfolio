...
function Studies () {
  ...
  return (
    <section className='border border-[#5B5B5B] p-5 w-full  relative'>
      ...
      <div
        className=' flex overflow-x-hidden sm:overflow-y-hidden w-full items-center scroll-smooth  mt-5  '
        ref={scroll}
      >
